...
var feature3 = new Feature(new Point([269914, 6248592]));
var feature4 = new Feature(new Circle([500000, 6400000], 100000));

var featureCollection = [feature1, feature2, feature3, feature4];

//vector.getSource().addFeatures(featureCollection);
vector.getSource().addFeatures(featureCollection);
